 ...
 function Home(){
    ...
    <main className="flex-1 pt-20 p-4 bg-gradient-to-br from-color3 via-color4 to-color5  w-full flex flex-col items-center text-white">
        ...
        <div className="flex flex-row items-center justify-center mt-10">
            <Link to="/login">
                <button className="bgcolor3 text-white font-text py-2 px-4 mx-1 rounded-lg hover:bg-opacity-80 transition duration-300"> Zaloguj się</button>
            </Link>
            <Link to="/register">
                <button className="bgcolor3 text-white font-text py-2 px-4 mx-1 rounded-lg hover:bg-opacity-80 transition duration-300"> Zarejestruj się</button>
            </Link>
        </div>
    </main>
    )
